...
- under windows, it is "bootstrapper=\"script/shell_loop_compile.lua\"". 
- under linux shell script, it is 'bootstrapper="script/shell_loop_compile.lua"'
------------------------------------------------------------
]]
...
local function activate()
	...
	elseif(main_state==nil) then
		main_state=0;
		log("Hello World from script/shell_loop_compile.lua\n")
