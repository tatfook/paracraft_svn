--[[
Title: GSL history for user creations and evironment updates.
Author(s): LiXizhi
Date: 2009/7/29
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/GameServer/GSL_history.lua");
local history = Map3DSystem.GSL.history:new();
------------------------------------------------------------
]]
...
commonlib.setfield("Map3DSystem.GSL.history", history);
