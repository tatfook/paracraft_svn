...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aquarius/Inventory/InventoryPage.lua");
------------------------------------------------------------
...
local InventoryPage = {};
commonlib.setfield("MyCompany.Aquarius.InventoryPage", InventoryPage)

-- validate bag capacity ContainerSlots
function InventoryPage.GetItems()
end