...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aquarius/Inventory/MyBaseBags.lua");
------------------------------------------------------------
...
local MyBaseBagsPage = {};
commonlib.setfield("MyCompany.Aquarius.MyBaseBagsPage", MyBaseBagsPage)

-- validate bag capacity ContainerSlots
function MyBaseBagsPage.GetItems()
end

-- validate bag capacity ContainerSlots
function MyBaseBagsPage.InitBags()
end