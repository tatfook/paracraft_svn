...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aries/BBSChat/ChannelContextMenu.lua");
MyCompany.Aries.ChannelContextMenu.Show(bShow);
------------------------------------------------------------
]]
-- create class
...
commonlib.setfield("MyCompany.Aries.ChannelContextMenu", ChannelContextMenu);
