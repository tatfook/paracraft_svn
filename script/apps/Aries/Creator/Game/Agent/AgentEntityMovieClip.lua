...
local Entity = commonlib.inherit(commonlib.gettable("MyCompany.Aries.Game.EntityManager.EntityCode"), commonlib.gettable("MyCompany.Aries.Game.EntityManager.AgentEntityMovieClip"));
