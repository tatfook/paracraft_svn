...
{
	type = "QuestAction_IncreaseNumberValue", 
	message0 = L"增加任务目标%1数值%2",
	arg0 = {
		{
			name = "target_id",
			type = "input_value",
			shadow = { type = "text", value = "target_id",},
			text = "target_id", 
		},
		{
			name = "defaultvalue",
	...
	nextStatement = true,
	canRun = false,
	func_description = 'QuestAction_IncreaseNumberValue(%s, %s)',
	ToNPL = function(self)
		return string.format('QuestAction_IncreaseNumberValue("%s", %s)', self:getFieldAsString('target_id'), self:getFieldAsString('defaultvalue'));
	end,
	examples = {{desc = L"", canRun = true, code = [[
-- 任务目标"60003_1"的数值+1
QuestAction_IncreaseNumberValue("60003_1",1)
]]},
},
},
...
{
	type = "QuestAction_SetValue_String", 
	message0 = L"设置任务目标%1数值为%2",
	arg0 = {
		{
			name = "target_id",
			type = "input_value",
	...
	nextStatement = true,
	canRun = false,
	func_description = 'QuestAction_SetValue(%s, %s)',
	ToNPL = function(self)
		return string.format('QuestAction_SetValue("%s", "%s")', self:getFieldAsString('target_id'), self:getFieldAsString('defaultvalue'));
	end,
	examples = {{desc = L"", canRun = true, code = [[
-- 设置任务目标"60003_2"的值等于字符串"abc"
QuestAction_SetValue("60003_2","abc")
]]},
},
},

{
	type = "QuestAction_SetValue", 
	message0 = L"设置任务目标%1数值为%2",
	arg0 = {
		{
			name = "target_id",
	...
	examples = {{desc = L"", canRun = true, code = [[
-- 设置任务目标"60003_1"的数值等于5
QuestAction_SetValue("60003_3",5)
]]},
},
},
...

{
	...
	nextStatement = true,
	canRun = false,
	func_description = 'QuestAction_DoFinish(%s)',
	ToNPL = function(self)
		return string.format('QuestAction_DoFinish(%s)', self:getFieldAsString('quest_gsid'));
	end,
	examples = {{desc = L"", canRun = true, code = [[
--完成任务
QuestAction_DoFinish(60001)
]]},
},
},
