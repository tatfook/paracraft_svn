...
------------------------------------------------------------
script/apps/Aries/NPCs/TownSquare/30353_Tumbler.lua
------------------------------------------------------------
]]
NPL.load("(gl)script/apps/Aries/Desktop/GUIHelper/CustomMessageBox.lua");
-- create class
local libName = "Tumbler";
local Tumbler = {};
commonlib.setfield("MyCompany.Aries.Quest.NPCs.Tumbler", Tumbler);
...
-- Tumbler.main
function Tumbler.main()
end
function Tumbler.PreDialog(npc_id, instance)
...
function Tumbler.DoExchange()
	...
	if(copies < 3)then
		...
		ItemManager.ExtendedCost(292, nil, nil, function(msg)end, function(msg)
				commonlib.echo("======Get_30102_RolyPoly return");
				commonlib.echo(msg);
