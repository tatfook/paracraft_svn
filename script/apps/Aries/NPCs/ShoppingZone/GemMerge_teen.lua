...
function GemMerge_teen.ShowPage()
	...
	local params = {
        url = "script/apps/Aries/NPCs/ShoppingZone/GemMerge_teen.html", 
        app_key = MyCompany.Aries.app.app_key, 
        name = "GemMerge_teen.ShowPage", 
...
function GemMerge_teen:CalcQidou()
	self.CostQidou = (Avatar_gems_subpage.CostQidouUnit or 0) * Avatar_gems_subpage.IncomingGem.copies;
	if(self.CostQidou == 0) then
		self.CostQidou = "";
	end
end

function GemMerge_teen:Clean()
	self.mergeOdd = 0;
	self.CostQidou = "";
