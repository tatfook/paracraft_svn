...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aries/Books/TimesMagazine/TimesMagazine_v3.lua");
-------------------------------------------------------
]]
local TimesMagazine_v3 = {

	
}
commonlib.setfield("MyCompany.Aries.Books.TimesMagazine_v2",TimesMagazine_v3);
function TimesMagazine_v3.GetAssetList()
	--local list = {
