--[[
Title: item attribute viewer page
Author(s): WangTian
Date: 2009/5/5
Desc: script/apps/Aries/Pipeline/ItemAttributeViewer/ItemAttributeViewerPage.html
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/apps/Aries/Pipeline/ItemAttributeViewer/ItemAttributeViewerPage.lua");
-------------------------------------------------------
]]
