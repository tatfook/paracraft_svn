...
local official_package_url = "http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedTextureListData";
...
function TextureModPage.GetTexturePackage(type,packagepath,url,callbackfun)
	return TexturePackageList.GetTexturePackage(type,packagepath,url,callbackfun);
end
...
function TextureModPage.OnApplyTexturePack(type,path,url,package,callbackfun)
	if(package) then
		...
		TextureModPage.GetTexturePackage(type,path,url,function (package)
			if(package) then
				TextureModPage.ResetCurrentTexPackage(package);
				WorldCommon.SetTexturePackageInfo(package);
				package:ApplyTexturePackage();
...
function TextureModPage.SelectTexture(name,mcmlNode)
	...
	if(package:IsDownloaded()) then
		...
		TextureModPage.OnApplyTexturePack(nil,nil,nil,package,function ()
