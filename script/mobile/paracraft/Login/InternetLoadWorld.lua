...
function InternetLoadWorld.OnStaticInit()
	...
	DefaultServerPage_ds = {
		{text=L"推荐列表", name="recommend", ds=nil, url="http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedServerListData", },
		{text=L"长篇电影", name="longfilm", ds=nil, url="http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedServerListData", },
		{text=L"短篇电影", name="shortfilm", ds=nil, url="http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedServerListData", },
		{text=L"教学电影", name="tutorial", ds=nil, url="http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedServerListData", },
		{text=L"其他电影", name="other", ds=nil, url="http://www.paraengine.com/twiki/bin/view/CCWeb/RecommendedServerListData", },
	...
	InternetLoadWorld.ServerPage_ds = DefaultServerPage_ds;
end
...
function InternetLoadWorld.ShowPage(bShow)
	...
	System.App.Commands.Call("File.MCMLWindowFrame", {
		url = "script/mobile/paracraft/Login/InternetLoadWorld.html", 
		name = "LoadMainWorld", 
...
function InternetLoadWorld.EnterWorld(name)
	...
	elseif(mouse_button == "right") then
		_guihelper.MessageBox(format(L"确定要删除缓存:%s?", world.text or ""), function(res)
...
--
		...
		--if(url and string.match(url,"^%d+$") or string.match(url,"^online")) then
			--_guihelper.MessageBox("只有登录后才能查看自己在线世界和他人世界。");
			--return;
		--end
	--end
