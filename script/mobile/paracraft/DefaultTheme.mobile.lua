...
local DefaultTheme = commonlib.gettable("ParaCraft.Mobile.Theme.Default");
...
function DefaultTheme:Load()
	...
	_guihelper.SetDefaultMsgBoxMCMLTemplate("script/mobile/paracraft/GUI/DefaultMessageBox.html");
	...
	scrollbar_track = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;11 36 7 32";
	scrollbar_thumb = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;2 36 7 32"; 
	scrollbar_upleft = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;0 0 0 0";
	scrollbar_downright = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;0 0 0 0";
	...
	_font.font = "System;20;norm";
	_this:GetAttributeObject():SetField("Spacing", 4);
	...
	_guihelper.MessageBox_BG = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;2 2 32 32:12 12 12 12";
	...
	_guihelper.OK_BG = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;240 2 32 32:12 12 12 12";
	
	_guihelper.Cancel_BG = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;240 2 32 32:12 12 12 12";
	...
	if(System.options.mc) then
		pe_select.listbox_bg = "Texture/Aries/Creator/Theme/GameCommonIcon_32bits.png;429 176 20 14:8 6 8 6";
	end
	...
	CommonCtrl.SliderBar.background = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;70 2 32 32:2 2 2 2";
	CommonCtrl.SliderBar.button_bg = "Texture/Aries/Creator/Mobile/blocks_UI_32bits.png;240 2 32 32:12 12 12 12";
	CommonCtrl.SliderBar.button_width = 32;
	CommonCtrl.SliderBar.button_height = 47;
	CommonCtrl.SliderBar.background_margin_top = 18;
	CommonCtrl.SliderBar.background_margin_bottom = 18;
	...
	pe_css.default = {
		...
		["mobile_bigtext"] = {["font-size"] = 40, ["base-font-size"] = 40,  color="#ffffff"},
		...
		["text"] = {["font-size"] = 20, ["base-font-size"] = 20},
	...
	CommonCtrl.ContextMenu.DefaultStyle = {
		...
		menu_bg = "Texture/Aries/Common/ThemeTeen/tooltip_bg_32bits.png:2 2 2 2", 
		shadow_bg = nil,
	...
	Map3DSystem.App.MiniGames.SwfLoadingBarPage.url="script/mobile/paracraft/Login/SwfLoadingBarPage.mobile.html";
