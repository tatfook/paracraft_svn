...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/kids/3DMapSystemUI/Env/TerraFormPage.lua");
------------------------------------------------------------
]]
NPL.load("(gl)script/ide/timer.lua");

local TerraFormPage = {};
commonlib.setfield("Map3DSystem.App.Env.TerraFormPage", TerraFormPage)
...
TerraFormPage.terrainFilterList = {
	{filtername = "GaussianHill", heightScaleSign=1, tooltip="GaussianHill增加地面高度", icon="Texture/3DMapSystem/Env/raise.png"},
	{filtername = "GaussianHill", heightScaleSign=-1, tooltip="GaussianHill降低地面高度", icon="Texture/3DMapSystem/Env/dig.png"},
	{filtername = "Flatten", tooltip="铲平地面到指定高度", icon="Texture/3DMapSystem/Env/flatten.png"},
	{filtername = "Roughen_Smooth", bRoughen=false, tooltip="平滑", icon="Texture/3DMapSystem/Env/smooth.png"},
	{filtername = "Roughen_Smooth", bRoughen=true, tooltip="锐化", icon="Texture/3DMapSystem/Env/rough.png"},
	
	{filtername = "RadialScale", heightScaleSign=1, tooltip="四面环山", icon="Texture/3DMapSystem/Env/waterup.png"},
	{filtername = "RadialScale", heightScaleSign=-1, tooltip="反向四面环山", icon="Texture/3DMapSystem/Env/waterlower.png"},
	{filtername = "SetHole", tooltip="制造山洞", icon="Texture/3DMapSystem/Env/nowater64.png"},
	{filtername = "Ramp", tooltip="制造斜面:Ramp", icon="Texture/3DMapSystem/Env/slope3.png"},
};
...
local DefaultBrush = Map3DSystem.App.Env.TerrainBrush:new({})
-- current brush
...
function TerraFormPage.OnInit()
	...
	if(TerraFormPage.SelectedIndex~=nil) then
		...
		TerraFormPage.CurBrush = Map3DSystem.App.Env.TerrainBrush.Brushes[filtername] or DefaultBrush
