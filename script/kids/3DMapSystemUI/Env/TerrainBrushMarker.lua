...
local TerrainBrushMarker = {};
commonlib.setfield("Map3DSystem.App.Env.TerrainBrushMarker", TerrainBrushMarker)

TerrainBrushMarker.Assets = {
	["center"] = "model/common/editor/z.x",
	["point"] = "model/common/editor/scalebox.x",
	["cell_region"] = "model/07effect/v5/Firecracker/Firecracker1.x",
