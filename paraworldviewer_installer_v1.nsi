...
;Language Selection Dialog Settings
  ...
  !define MUI_LANGDLL_REGISTRY_KEY "Software\ParaEngine\ParaWorldViewer" 
...
;Pages
  ...
  !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\ParaEngine\ParaWorldViewer" 
  !define MUI_STARTMENUPAGE_REGISTRY_VALUENAME "ParaWorldViewer"
...
;-----------------------------------------------------------------------------------------------------  
!define PROGRAM_NAME "ParaWorldViewer"
...
; short cuts
LangString StringExeName ${LANG_ENGLISH} "ParaWorld Viewer"
LangString StringExeName ${LANG_SIMPCHINESE} "帕拉巫-迷你播放器"
...
section
	...
	File /oname=bootstrapper.xml "config\bootstrapper_paraworldviewer.xml"
	...
	SetOutPath $INSTDIR\worlds\MyWorlds\KongFuChat
		File /r /x *.bak worlds\MyWorlds\KongFuChat\*.*
	
	;-------------- DEMO RELEASE remove following worlds at formal release	-------------------------------
	SetOutPath $INSTDIR\worlds\MyWorlds\chat01
		File /r /x *.bak worlds\MyWorlds\chat01\*.*	
	...
	SetOutPath $INSTDIR
	File /oname=main.pkg "installer\main_hellochat.pkg"
	...
	WriteRegStr HKCU "Software\ParaEngine\ParaWorldViewer" "" $INSTDIR
...
section "Uninstall"
	...
	DeleteRegKey /ifempty HKCU "Software\ParaEngine\ParaWorldViewer"
	DeleteRegKey HKCR "paraworldviewer"
